            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    236 5th FLOOR, Karachi, Pakistan.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Mobile: (021) 123-4567</p>
                  <p className="text-gray-600">Hotline: (021) 456-6789</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <Link
                    href="https://www.instagram.com/its_tanzeel_here_07/"
                    target="_blank"
